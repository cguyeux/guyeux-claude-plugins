...
4. La fiche de la revue à jour : `python3 packaged skill root/skills/soumission/scripts/journals.py lint`
...
```bash
python3 scripts/corpus_fit.py fetch <cle> --months 12
python3 scripts/corpus_fit.py situate <cle> \
...
```bash
python3 packaged skill root/skills/soumission/scripts/preflight.py --vitrine-empreinte article/main.tex
```
