...
\begin{tikzpicture}[
  ...
  \node[inner sep=0pt] at (6.3,-0.6)  {\textcolor{humanblue}{\includegraphics[height=1.15cm]{human.pdf}}};
  \node[inner sep=0pt] at (6.3,-2.55) {\textcolor{animorange}{\includegraphics[height=0.85cm]{cattle.pdf}}};
  \node[inner sep=0pt] at (6.3,-3.35) {\textcolor{animorange}{\includegraphics[height=0.72cm]{goat.pdf}}};
  \node[inner sep=0pt] at (6.3,-4.7)  {\textcolor{animorange}{\includegraphics[height=0.62cm]{seal.pdf}}};
