...
2. Lancer `geo-map` en mode approprie, sortie en PDF vectoriel place
   ...
   python3 /home/christophe/docs/codes/claude_plugins/bio_pathogens/skills/geo-map/scripts/geo_map.py \
...
disponibles (canoniques dans ~/docs/codes/claude_plugins/bio_pathogens/skills/) :
