...
# gpd.datasets.get_path('naturalearth_lowres') a ete DEPRECIE en 0.13 et
# RETIRE en GeoPandas 1.0. Charger via le package geodatasets :
from geodatasets import get_path   # pip install geodatasets
world = gpd.read_file(get_path('naturalearth.land'))
# Pour les frontieres/attributs pays (pop_est, continent), telecharger
# Natural Earth "admin_0_countries" (naturalearthdata.com) et lire le .shp.

# Filter and Project (noms de colonnes = ceux du jeu Natural Earth charge)
