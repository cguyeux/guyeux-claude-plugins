...
```bash
python3 "scripts/enrich_film_metadata.py" "Cléopâtre" --orig-title "Cleopatra" --year 1934 --director "Cecil B. DeMille"
```
Retourne :
...
python3 "scripts/imdb_lookup.py" meta
python3 "scripts/imdb_lookup.py" update
```
