...
`mtbc/clos/Rv0007`, arrêté sur une thèse déjà publiée par sa
...
- **NE-PAS-DIFFUSER** : phase 4 mode (d), puis phase 5, archivage dans
  `clos/`. **Obligatoire avant l'archivage** : passe `/recadrage`
...
trop tard une fois de trop : `mtbc/clos/Rv0007` a franchi la
