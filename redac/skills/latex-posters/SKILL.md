...
**Recommandation : un poster de recherche gagne à contenir 2-3 figures/schémas** (les posters trop textuels communiquent mal). Viser :
1. Au minimum DEUX schémas ou diagrammes
2. 3-4 figures pour un poster complet (flowchart méthodo, visualisation des résultats clés, cadre conceptuel)
