...
whether torch + fair-esm are importable, WITHOUT loading the ~2.6 GB model. Run with
both skills on PYTHONPATH and a torch+fair-esm interpreter:

    SK=/home/christophe/docs/codes/claude_plugins/bio_pathogens/skills
    PYTHONPATH="$SK/mtbc-mutation-impact/src:$SK/mtbc-gene-function/src" \\
