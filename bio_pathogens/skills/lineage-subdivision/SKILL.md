...
```bash
S=${CLAUDE_PLUGIN_ROOT}/skills/lineage-subdivision/scripts/clade_finder.py
python3 "$S" /path/to/bdd/actuelle/L4.9/ [options]
# ou, depuis un plugin : "$CLAUDE_PLUGIN_ROOT/skills/lineage-subdivision/scripts/clade_finder.py"
```
...
S=${CLAUDE_PLUGIN_ROOT}/skills/lineage-subdivision/scripts/lineage_mdl.py
