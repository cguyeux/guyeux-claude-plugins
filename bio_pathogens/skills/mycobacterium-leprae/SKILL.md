...
description: >-
  Academic literature reference. Curated bibliography of peer-reviewed
  paleogenomic research studies of Mycobacterium leprae — the richest
  published ancient-DNA research corpus for any Mycobacterium (49 ancient
  genomes published across 13 countries spanning 2200 years, vs 16 for
  ancient MTBC). Indexes the canonical academic papers (Schuenemann 2013,
  2018; Krause-Kyora 2018; Kerudin 2019; Fotakis 2020; Neukamm 2020;
  Pfrengle 2021; Bonczarowska 2022; Urban 2024), the documented
  non-human zoological reservoirs (nine-banded armadillo, medieval
  English red squirrels), the documented European phylogeographic
  origin of New World samples, and the five canonical published
  M. leprae phylogenetic lineages. Used by the Guyeux group as the
  comparative scholarly reference for academic ancient-DNA evolutionary
  research on the Mycobacterium genus.

  Use when: writing a comparative section of a research manuscript on
  M. leprae vs M. tuberculosis paleogenomic trajectories, preparing
  scientific seminar slides on ancient Mycobacterium genomics for a
  peer audience, contextualizing zoonotic reservoirs in a research
  article, or transposing published paleogenomic methodology to MTBC.
---
