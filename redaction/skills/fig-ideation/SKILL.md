...
```
python3 ${CLAUDE_PLUGIN_ROOT}/skills/fig-ideation/scripts/sci_icons.py taxon 9606 9913 9925 9709 --libre
python3 ${CLAUDE_PLUGIN_ROOT}/skills/fig-ideation/scripts/sci_icons.py search bacteri --category Microbiology
```
...
```
python3 ${CLAUDE_PLUGIN_ROOT}/skills/fig-ideation/scripts/fig_gap_scan.py <main.tex> --json /tmp/figgap.json
```
