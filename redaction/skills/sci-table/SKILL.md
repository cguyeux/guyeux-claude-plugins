...
argument-hint: "[main.tex | data.csv] [review | design | build]"
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/sci-table/scripts/table_lint.py main.tex
python3 ${CLAUDE_PLUGIN_ROOT}/skills/sci-table/scripts/table_lint.py main.tex supplementary.tex --width 48
python3 ${CLAUDE_PLUGIN_ROOT}/skills/sci-table/scripts/table_lint.py --corpus ~/docs/codes/mtbc --json
```
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/sci-table/scripts/table_build.py data.csv \
