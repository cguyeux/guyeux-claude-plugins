...
def build_internal_commands() -> list[list[str]]:
    return [
        ...
        [sys.executable, "_audit/tools/audit_claude_memories.py", "--check"],
...
def build_external_farm_commands(profile_root: Path) -> list[list[str]]:
    return [
        ...
        [sys.executable, "_audit/tools/maintain_environment.py", "validate"],
        ...
        [sys.executable, "_audit/tools/skills_farm.py", "audit", "--profile-root", str(profile_root)],
    ]
