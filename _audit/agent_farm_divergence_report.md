...
| init-project | payload-review-required | manual-review-required | 0 | 0 | 2 | SKILL.md:+8/-44, init_project.py:+24/-849 |
...
| plugin-structure | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+25/-25 |
| recall | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+4/-4 |
| reflect | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+3/-3 |
| researcher | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+47/-57 |
| skill-creator | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+21/-21 |
| skill-development | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+25/-25 |
| update | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+1/-1 |
| using-git-worktrees | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+9/-9 |
| web-artifacts-builder | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+3/-3 |
| write-query | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+1/-1 |
| writing-hookify-rules | instruction-review-required | manual-review-required | 0 | 0 | 1 | SKILL.md:+7/-7 |
